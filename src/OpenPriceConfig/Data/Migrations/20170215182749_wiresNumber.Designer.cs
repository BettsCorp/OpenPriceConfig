...
namespace OpenPriceConfig.Data.Migrations
{
    ...
    [Migration("20170215182749_wiresNumber")]
    partial class wiresNumber
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("OpenPriceConfig.Models.Option", b =>
                {
                    ...
                    b.Property<int>("BracketPricingType");
            ...
            modelBuilder.Entity("OpenPriceConfig.Models.Option", b =>
                {
                    b.HasOne("OpenPriceConfig.Models.Configurator", "Configurator")
                        .WithMany("Options")
